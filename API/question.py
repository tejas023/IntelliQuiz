...
Original file is located at
    https://colab.research.google.com/drive/1jb_44SVVEtTCW-5SmvqyFwoN9CVsu4rC
"""
...
#yahan pe hm log questions nikalenge
...
def generateQuestions(text, count):
    ...
    for i in range(0,count,12):
        print("Question:",(j+1))
        print(qaPairs[i]['question'])
        print("Answer:")
        print(qaPairs[i]['answer'])
        j=j+1
        print()
    return qaPairs

#isme topic daal search krne ke liye
page_py = wiki_wiki.page('Python programming')
full_text = page_py.summary

#aur ye rhe tmhare questions
qaPairs = generateQuestions(full_text, 100)
