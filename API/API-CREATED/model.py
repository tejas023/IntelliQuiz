...
#yahan pe hm log questions nikalenge, code mt dekhna ga** phat jaegi...bss run krdo
...
def final(topic):
    #isme topic daal search krne ke liye
    wiki_wiki = wikipediaapi.Wikipedia('en')
    page_py = wiki_wiki.page(topic)
    full_text = page_py.summary
    # print(topic)
    # print(full_text)
    #aur ye rhe tmhare questions
    qaPairs = generateQuestions(full_text,10)
    # print((qaPairs))
    return qaPairs
